...
if (isset($_POST["update"])) {
    ...
    mysqli_query($conn,"UPDATE `table_uploads` SET `name` = '$name', `price` = '$price', `model` = '$model', `engin` = '$engin', `colors` = '$colors', `madein` = '$madein' WHERE id='$id'");
    // mysqli_query($con,"UPDATE `tblcard` SET `Name`='$NAME',`Price`='$PRICE',`Image`='$img_des' WHERE Id = '$ID' ");
    header('location: add-to-sell.php?p=1');  
}
?>
<!DOCTYPE html>
<html lang="en">
